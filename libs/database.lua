...
function database:new(tableName)
    ...
    function obj:init()
        self.fullPath = shell.getWorkingDirectory() .. "/DB/" .. tableName .. "/"
        self.dataPath = shell.getWorkingDirectory() .. "/DB/" .. tableName .. '/data/'
        self.indexPath = shell.getWorkingDirectory() .. "/DB/" .. tableName .. '/index/'
        self:createDataBase()
    end

    function obj:createDataBase()
        if (not fs.exists(shell.getWorkingDirectory() .. "/DB")) then
            fs.makeDirectory(shell.getWorkingDirectory() .. "/DB")
        end
